...
PGP_SYM_ENCRYPT_SQL = "pgp_sym_encrypt(%s, '{}', 's2k-mode=1, s2k-digest-algo=md5')"

PGP_PUB_DECRYPT_SQL = "pgp_pub_decrypt(%s, dearmor('{}'))::%s"
PGP_SYM_DECRYPT_SQL = "pgp_sym_decrypt_null_on_err(%s, '{}', 's2k-mode=1, s2k-digest-algo=md5')::%s"
